#' Learn FGES network with StARS (most stable graph) and calculate LaGrACE divergence score
#'
...
run_LaGrACE_StARS <- function(input_data, reference_samples,maxCat=5, out_dir) {
  ...
  # Run FGES
  fges_out_net_file <- learn_fges_network_StARS(fges_in_file_path,maxCat =maxCat, paste0(out_dir,'/FGES'))
